...
module.exports = class Game {
  ...
  endCollector(msg, hp, ...ints) {
    ...
    msg.edit(
      new RichEmbed()
      .setTitle("Field of Battle")
      .addField("Enemy #" + this.enemycount, "You and your team have encountered " + (this.enemy.name == "General" ? "the **" + this.enemy.name + "**" : "a "+ this.enemy.name) + "! Press the sword reaction to hit him. You have 0s.")
